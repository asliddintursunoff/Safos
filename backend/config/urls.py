...
from apps.users.api.auth import AllowAnyTokenRefreshView, LoginAPIView
...
urlpatterns = [
    ...
    path('api/markets/', include('apps.markets.api.urls')),
    ...
    path('api/token/refresh/', AllowAnyTokenRefreshView.as_view(), name='token_refresh'),
