...
DATABASES = {
    'default': {
        ...
        'USER': env("POSTGRES_USER", "asliddintursunoff"),
...
CELERY_BEAT_SCHEDULE = {
    "refresh-market-possible-status": {
        "task": "apps.markets.tasks.refresh_market_possible_status",
        "schedule": timedelta(minutes=15),
    },
}

MARKET_STATUS_DEFAULT_REFRESH_DAYS = int(
    env("MARKET_STATUS_DEFAULT_REFRESH_DAYS", "5")
)
